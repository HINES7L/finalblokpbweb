...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2025 at 12:29 PM
...
(74, 'Shadows of the Moon', 'KODE036', '2023-02-05', 'RAK036', 32),
...
(20, 66, 74, 23, '2024-12-08', '2024-12-09', '', '12'),
(21, 67, 93, 63, '2024-12-08', '2024-12-11', '', '5');
...
(64, 'ss', '8656', 1, 17),
(66, 'nesya', '5647456745', 1, 25),
(67, 'steven susanto', '434234', 2, 28);
...
(24, 'S7NES@gmail.com', '37693cfc748049e45d87b8c7d8b9aacd', '1'),
(25, 's8en7', '110739f02a7d0fa513d3e63370856eda', '1'),
(26, 'muhammadsaynur12@gma', '202cb962ac59075b964b07152d234b70', '1'),
(28, 'ss@kece', 'a3026b0a6849f749c489cd798654a809', '1'),
(29, 'kepin123@gmail.com', '202cb962ac59075b964b07152d234b70', '1'),
(30, 'nesya15@gmail.com', '202cb962ac59075b964b07152d234b70', '1'),
(31, 'ray@gmail.com', '202cb962ac59075b964b07152d234b70', '1');
...
--
ALTER TABLE `buku`
  MODIFY `id_buku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
...
--
ALTER TABLE `peminjaman`
  MODIFY `id_peminjam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `petugas`
--
ALTER TABLE `petugas`
  MODIFY `id_petugas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
